...
namespace MarketHub.Persistence.Migrations
{
    ...
    [Migration("20230621074853_UpdatedPasswordRecovery")]
    partial class UpdatedPasswordRecovery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketHub.Domain.Entities.Users.Recoveries.PasswordRecovery", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MarketHub.Domain.Entities.Users.Recoveries.PasswordRecovery", b =>
                {
                    b.HasOne("MarketHub.Domain.Entities.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("MarketHub.Domain.Entities.Users.Recoveries.PasswordRecovery", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
